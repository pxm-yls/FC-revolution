...
public interface IGameSessionService
{
    ...
    bool TryAcquireRemoteControl(Guid sessionId, string portId, string clientIp, string? clientName = null);
    void ReleaseRemoteControl(Guid sessionId, string portId, string? reason = null);
    void RefreshRemoteHeartbeat(Guid sessionId, string portId);
    ...
    bool IsRemoteOwner(Guid sessionId, string portId, string clientIp, string? clientName = null);
